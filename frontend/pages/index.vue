<template>
  <div>
    ...
    <amplify-authenticator>
      <amplify-sign-in slot="sign-in">
        <amplify-sign-in-button slot="federated-buttons">
          <div class="pb-2">
            <a href="#" @click="onClickFacebook" class="fb connect">Sign in with Facebook</a>
          </div>
          <br>
          <div class="">
            <a href="#" @click="onClickGoogle"
               class="sign-in-with-google"><span>Sign in with <strong>Google</strong></span></a>
          </div>
    ...
    <pre><code>{{ JSON.stringify(this.authUser, null, 4) }}</code></pre>
